...
const NEW_FAMILIES: FamilySource[] = [
  ...
  {
    draw: INTERACTIVE_ENGINES.snowGlobe,
    icon: "❄️",
    category: "Dreamy",
    heroTime: 2.1,
    palettes: [
      pal("Midnight Keepsake", ["#0b1220", "#16233a", "#dbeafe", "#93c5fd", "#fcd34d"]),
      pal("Rose Frost", ["#1a0f16", "#2c1a26", "#fecdd3", "#fda4af", "#fde68a"]),
      pal("Emerald Pine", ["#0a1510", "#12281d", "#a7f3d0", "#6ee7b7", "#fef3c7"]),
      pal("Amber Cabin", ["#140d08", "#2a1a10", "#fed7aa", "#fbbf24", "#fef3c7"]),
    ],
    names: ["Snow Globe", "Winter Captive", "Glass Blizzard", "Pine Hollow", "Frost Dome", "Silent Flurry", "Cottage Lights", "Shake the Sky", "Glacier Keepsake", "White Whirl"],
    taglines: [
      "Stir the snow — it swirls where you touch",
      "A tiny winter shaking inside glass",
      "Tap the glass — the storm answers",
      "Pines, powder and one warm window",
      "Snow that never settles, always dancing",
      "Your personal blizzard on a shelf",
      "Tip the world, watch it whirl",
      "A keepsake storm for cold nights",
    ],
    interact: { kind: "swirl", label: "Stir — snow swirls · Tap — glass shimmer" },
    tags: ["snow", "winter", "globe", "christmas", "frost", "cozy"],
  },
  {
    draw: INTERACTIVE_ENGINES.neonRain,
    icon: "🌧️",
    category: "Urban",
    heroTime: 1.2,
    palettes: [
      pal("Synthwave Storm", ["#0d0716", "#1d0f2e", "#f0abfc", "#22d3ee", "#fde047"]),
      pal("Sakura Drizzle", ["#160a12", "#2b1220", "#f9a8d4", "#fb7185", "#fde68a"]),
      pal("Toxic Monsoon", ["#0a120c", "#152417", "#bef264", "#fde047", "#f0abfc"]),
      pal("Ember Drizzle", ["#140b08", "#26130c", "#fb923c", "#f87171", "#fde68a"]),
    ],
    names: ["Neon Rain", "Rain Circuit", "Puddle Neon", "Midnight Drizzle", "City Static", "Wet Boulevard", "Arcade Downpour", "Signal Storm", "Gutter Glow", "Afterhours Shower"],
    taglines: [
      "Swipe — the rain bends away from you",
      "Neon signs hiss under a warm downpour",
      "Reflections ripple with every drop",
      "The city rinses itself at 2 AM",
      "Tap — a splash rings through the glow",
      "Wipers optional, vibes mandatory",
      "Rain that dodges your fingertip",
      "Electric puddles, endless drizzle",
    ],
    interact: { kind: "gust", label: "Sweep — bend the rain · Tap — splash" },
    tags: ["rain", "neon", "city", "cyberpunk", "night", "wet"],
  },
  {
    draw: INTERACTIVE_ENGINES.whaleSong,
    icon: "🐋",
    category: "Ocean",
    heroTime: 2.6,
    palettes: [
      pal("Abyss Lullaby", ["#04101c", "#0a2238", "#7dd3fc", "#a5f3fc", "#fde68a"]),
      pal("Twilight Dive", ["#0c0a1e", "#181436", "#c4b5fd", "#818cf8", "#fbcfe8"]),
      pal("Emerald Trench", ["#04140f", "#0a2820", "#5eead4", "#a7f3d0", "#fef08a"]),
      pal("Rose Abyss", ["#120a14", "#231229", "#f9a8d4", "#e879f9", "#fde68a"]),
    ],
    names: ["Whale Song", "Leviathan Lullaby", "Deep Current", "Ocean Giant", "Song of the Deep", "Blue Silence", "Drifting Titan", "Sonar Serenade", "Abyssal Waltz", "Gentle Giant"],
    taglines: [
      "The whale drifts toward your finger",
      "Tap — a sonar song rolls out",
      "Ancient songs in deep blue silence",
      "She hears you through the dark water",
      "Follow the glow — the giant follows you",
      "Slow tides, enormous patience",
      "A sonar ring blooms from the deep",
      "The ocean's largest heart, gently curious",
    ],
    interact: { kind: "attract", label: "Guide — whale drifts to you · Tap — sonar song" },
    tags: ["whale", "ocean", "deep", "sonar", "sea", "giant"],
  },
  {
    draw: INTERACTIVE_ENGINES.paperCranes,
    icon: "🕊️",
    category: "Nature",
    heroTime: 1.8,
    palettes: [
      pal("Rice Paper Dawn", ["#1c1410", "#33241a", "#fed7aa", "#fda4af", "#fef3c7"]),
      pal("Indigo Fold", ["#101624", "#1c2740", "#93c5fd", "#e0e7ff", "#fcd34d"]),
      pal("Spring Washi", ["#121a10", "#1f2f1a", "#bef264", "#5eead4", "#fde68a"]),
      pal("Petal Fold", ["#1a1014", "#301a22", "#fda4af", "#f9a8d4", "#fde68a"]),
    ],
    names: ["Paper Cranes", "Origami Sky", "Thousand Wings", "Folded Flight", "Crane Ballet", "Paper Wind", "Senbazuru", "Glide of a Thousand", "Folded Wishes", "Flutter Fleet"],
    taglines: [
      "Cranes bank away as your cursor nears",
      "Tap — a flutter of paper feathers",
      "Folded wishes riding the wind",
      "A thousand wings, one quiet sky",
      "Origami flock on an afternoon breeze",
      "They scatter like notes in the wind",
      "Paper wings over a rice-paper sun",
      "Every fold catches the light",
    ],
    interact: { kind: "flee", label: "Approach — cranes bank away · Tap — flutter" },
    tags: ["origami", "crane", "paper", "birds", "zen", "fold"],
  },
  {
    draw: INTERACTIVE_ENGINES.murmuration,
    icon: "🐦",
    category: "Nature",
    heroTime: 2.1,
    palettes: [
      pal("Dusk Flight", ["#120b1c", "#241436", "#f9a8d4", "#c4b5fd", "#fde68a"]),
      pal("Amber Roost", ["#170d08", "#2b1a10", "#fbbf24", "#fb923c", "#fde68a"]),
      pal("Sea Smoke", ["#06121a", "#0d2434", "#7dd3fc", "#a5f3fc", "#e0f2fe"]),
      pal("Rosewing", ["#1a0a12", "#31121f", "#fb7185", "#f9a8d4", "#fecdd3"]),
    ],
    names: ["Murmuration", "Starling Wave", "Feather Storm", "Sky Ballet", "Birds of Dusk", "Flock & Fold", "Wing Current", "Twilight Swarm", "Birdsong Drift", "Skyline Sparrows"],
    taglines: [
      "A thousand wings thinking as one — they scatter when you touch",
      "Starlings rehearsing their evening ballet",
      "The sky braids itself out of feathers",
      "One hawk-shaped thought, ten thousand wings",
      "Dusk gets a standing ovation",
      "Birds folding into the wind like silk",
      "A swarm writing cursive on the wind",
      "Twilight traffic, all of it going somewhere",
      "Where the wind learns choreography",
      "Small wings, enormous ideas",
    ],
    interact: { kind: "flee", label: "Touch — the flock scatters · Tap — hawk-scare" },
    tags: ["birds", "flock", "starlings", "swarm", "murmuration", "dusk"],
  },
  {
    draw: INTERACTIVE_ENGINES.gravityWells,
    icon: "🪐",
    category: "Space",
    heroTime: 2.7,
    palettes: [
      pal("Deep Field", ["#040611", "#0b1126", "#93c5fd", "#c4b5fd", "#fde68a"]),
      pal("Red Giant", ["#0d0508", "#220a10", "#fb7185", "#fdba74", "#fecaca"]),
      pal("Emerald Belt", ["#03100d", "#082018", "#2dd4bf", "#a7f3d0", "#fef08a"]),
      pal("Ivory Eclipse", ["#0a0a0c", "#17171c", "#e5e7eb", "#fbbf24", "#fca5a5"]),
    ],
    names: ["Gravity Wells", "Orbit Garden", "Kepler Dreams", "Ring Traveler", "Perihelion", "Asteroid Waltz", "Lunar Carousel", "Escape Velocity", "Ninth Planet", "Tidal Lock"],
    taglines: [
      "Your cursor is a gravity well — bend the orbits",
      "Planets keeping their promises to the sun",
      "A quiet garden where worlds do laps",
      "Catch the ring traveler at apogee",
      "The closest kiss a comet can give",
      "Asteroids waltzing in three-quarter time",
      "Every moon takes the scenic route",
      "Fast enough to leave, beautiful enough to stay",
      "Somewhere out past the charts",
      "Two bodies, one stubborn attraction",
    ],
    interact: { kind: "magnet", label: "Hover — gravity bends orbits · Tap — asteroid shower" },
    tags: ["planets", "orbit", "gravity", "asteroids", "solar", "space"],
  },
  {
    draw: INTERACTIVE_ENGINES.spiritOrchids,
    icon: "🌸",
    category: "Dreamy",
    heroTime: 1.9,
    palettes: [
      pal("Moonlit Meadow", ["#0c0a1a", "#1a1430", "#e9d5ff", "#f9a8d4", "#fde68a"]),
      pal("Ember Blossom", ["#160a0c", "#2c1216", "#fda4af", "#fbbf24", "#fecdd3"]),
      pal("Mint Whim", ["#071410", "#0f2a22", "#a7f3d0", "#fef3c7", "#f9a8d4"]),
      pal("Amethyst Hush", ["#120a1e", "#221238", "#d8b4fe", "#a5f3fc", "#fda4af"]),
    ],
    names: ["Spirit Orchids", "Ghost Petals", "Midnight Bloom", "Flower Whisper", "Petal Fade", "Moon Garden", "Velvet Blossom", "Hush Lily", "Dream Nectar", "Fairy Acre"],
    taglines: [
      "Hold your finger still — flowers bloom for you",
      "Petals that glow after sundown",
      "A garden that blooms only for the patient",
      "Whispers of pollen in the dark",
      "Every petal a small goodnight",
      "The moon waters these",
      "Blossoms with velvet on their minds",
      "A lily that learned to hush",
      "Nectar for dreams, not bees",
      "One acre of quiet magic",
    ],
    interact: { kind: "bloom", label: "Hold — flowers bloom · Tap — petal storm" },
    tags: ["flowers", "orchid", "bloom", "garden", "petals", "zen"],
  },
  {
    draw: INTERACTIVE_ENGINES.galaxySpinner,
    icon: "🌌",
    category: "Abstract",
    heroTime: 2.4,
    palettes: [
      pal("Cosmic Latte", ["#0b0810", "#1c1526", "#fde68a", "#f9a8d4", "#a5f3fc"]),
      pal("Ember Spiral", ["#0e0708", "#221014", "#fb923c", "#fbbf24", "#fecaca"]),
      pal("Aurora Disk", ["#051012", "#0c2026", "#5eead4", "#a7f3d0", "#fef08a"]),
      pal("Violet Core", ["#0d0716", "#1c0f2e", "#d8b4fe", "#f0abfc", "#7dd3fc"]),
    ],
    names: ["Galaxy Spinner", "Spiral Drift", "Arm of Dawn", "Star Bazaar", "Core Whisper", "Andromeda Mix", "Pinwheel Night", "Cosmic Latte Two", "Dark Matter Disco", "Halo Hop"],
    taglines: [
      "Sweep to steer the spin — tap for a hypernova",
      "A pinwheel made of patient stars",
      "Spiral arms on their longest lap",
      "Everything bright is on sale tonight",
      "The core hums, the arms listen",
      "Two galaxies, one gentle collision",
      "Twist the night like a kaleidoscope",
      "Espresso for the cosmos — dark and swirling",
      "What dark matter does on weekends",
      "Orbit the halo, keep your ticket",
    ],
    interact: { kind: "swirl", label: "Sweep — steer the spin · Tap — hypernova" },
    tags: ["galaxy", "spiral", "stars", "cosmos", "spin", "space"],
  },
  {
    draw: INTERACTIVE_ENGINES.sandGarden,
    icon: "🪨",
    category: "Nature",
    heroTime: 2.0,
    palettes: [
      pal("Moss Court", ["#181512", "#2a241c", "#7a8b6f", "#c9b380", "#e8dcc3"]),
      pal("Dawn Raked", ["#1c1414", "#33231e", "#d9a066", "#b7c4a1", "#f2e6cf"]),
      pal("Dusk Stones", ["#141018", "#262031", "#8b7fa8", "#c9a86a", "#efe6d8"]),
      pal("Bamboo Spa", ["#121611", "#22301f", "#9ab37c", "#d8c48e", "#f4efe2"]),
    ],
    names: ["Sand Garden", "Raked Silence", "Stone Meditation", "Kyoto Morning", "Sand Mandala", "Still Court", "Monk's Patience", "Pebble Poem", "Quiet Sands", "Breathing Sand"],
    taglines: [
      "Drag your finger — the sand remembers",
      "Three stones, one breath, endless calm",
      "Rake your worries into patterns",
      "A courtyard that listens to your hand",
      "Tap — a pebble lands, rings ripple out",
      "Patience, drawn in sand",
      "Every stroke is a slow exhale",
      "The garden sweeps itself clean again",
    ],
    interact: { kind: "rake", label: "Drag — rake the sand · Tap — drop a pebble" },
    tags: ["zen", "sand", "stones", "rake", "calm", "garden", "meditation"],
  },
  {
    draw: INTERACTIVE_ENGINES.bonsaiGrow,
    icon: "🌳",
    category: "Nature",
    heroTime: 2.3,
    palettes: [
      pal("Jade Bonsai", ["#0d1410", "#1a2820", "#5fae7f", "#d9b36c", "#f0e6d2"]),
      pal("Blossom Tree", ["#160f14", "#2b1c24", "#e88ca0", "#7ba05b", "#f6ead9"]),
      pal("Autumn Maple", ["#160f0b", "#2d1c12", "#c96a3b", "#e0a458", "#f2e4c8"]),
      pal("Jade Pine", ["#0c1210", "#182420", "#6aa89a", "#c9b380", "#ece4d0"]),
    ],
    names: ["Bonsai Bloom", "Living Sculpture", "Slow Growth", "Grandfather Tree", "Miniature Forest", "Potted Sky", "Branch & Breath", "Growing Stillness", "The Patient Art", "Tiny Canopy"],
    taglines: [
      "Hold your finger — a new branch reaches for it",
      "Four hundred years, grown in an afternoon",
      "Tap — the canopy lets go of its leaves",
      "A forest the size of your palm",
      "Grow something quiet on your lock screen",
      "Pruned by time, arranged by you",
      "Stillness, with a heartbeat of leaves",
      "The ancient art that grows while you hold it",
    ],
    interact: { kind: "grow", label: "Hold — grow new branches · Tap — leaf burst" },
    tags: ["bonsai", "tree", "grow", "zen", "nature", "leaves", "branches"],
  },
  {
    draw: INTERACTIVE_ENGINES.candleSanctuary,
    icon: "🕯️",
    category: "Dreamy",
    heroTime: 1.9,
    palettes: [
      pal("Warm Vigil", ["#120b08", "#241408", "#f5b04a", "#e8804a", "#ffe9b8"]),
      pal("Rose Vespers", ["#150a10", "#2a121c", "#f2a2b8", "#e8825a", "#ffe4c4"]),
      pal("Amber Chapel", ["#100c06", "#221a0a", "#f7c05c", "#eb8f4e", "#fff1cf"]),
      pal("Frost Evening", ["#0c0d10", "#1a1e26", "#f0b86a", "#e0e8f0", "#ffdfb0"]),
    ],
    names: ["Candle Sanctuary", "Vigil Lights", "Wax & Whisper", "Chapel of Flames", "Night Lamps", "Soft Watch", "Gutter & Glow", "Little Lights", "Evening Prayers", "Flame Keepers"],
    taglines: [
      "Sweep the air — every flame leans away",
      "Hold still and the room breathes with you",
      "Tap — sparks climb from the wick",
      "Nine small suns keeping the night polite",
      "Wax remembers every evening",
      "The gentler way to light a room",
      "Blow softly — they flicker back",
      "A sanctuary you can carry",
    ],
    interact: { kind: "gust", label: "Sweep — your breath bends the flames · Tap — sparks" },
    tags: ["candle", "flame", "cozy", "light", "night", "warm", "fire"],
  },
  {
    draw: INTERACTIVE_ENGINES.stainedGlass,
    icon: "🪟",
    category: "Geometric",
    heroTime: 2.2,
    palettes: [
      pal("Cathedral Rose", ["#0e0a12", "#1d1424", "#e05a7a", "#f2b04a", "#5fb89a"]),
      pal("Amber Apse", ["#120c08", "#241a10", "#e8983a", "#d4585a", "#8ab06a"]),
      pal("Moon Transept", ["#0a0c12", "#161c28", "#9ac2d8", "#e0c878", "#c88aa8"]),
      pal("Rose Nave", ["#120a0e", "#241218", "#e07a9a", "#f0c05a", "#88b8a0"]),
    ],
    names: ["Stained Glass", "Rose Window", "Cathedral Light", "Glass Sanctum", "Pane & Prism", "Chromatic Choir", "Sun Through Glass", "Leaded Light", "Glass Rosette", "Sacred Geometry"],
    taglines: [
      "Move — the panes ignite around your cursor",
      "Tap — light floods through the rose",
      "Sunlight, cut into jewels",
      "A cathedral window for your pocket",
      "Every pane hums a different color",
      "Gothic geometry, glowing softly",
      "The light does the singing here",
      "Pray with your fingertip",
    ],
